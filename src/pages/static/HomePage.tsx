...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in">
      {/* Hero Section */}
      <section
        className="bg-dark text-white py-5 py-md-5 overflow-hidden position-relative"
        style={{
      ...
      >
        <div className="container py-5 text-center">
          ...
          >
            Discover, compare, and connect with verified professionals and
        ...
        <div className="d-flex justify-content-between align-items-end mb-5">
          <div>
            ...
            <p className="text-secondary small">
              Explore the most in-demand healthcare specialties.
            </p>
          </div>
          <Link
            to="/categories"
            className="text-indigo fw-semibold text-decoration-none d-flex align-items-center gap-1"
          >
        ...
        <div className="row g-4">
          {featuredCategories.map((cat, i) => (
            <div key={i} className="col-12 col-sm-6 col-lg-4">
              ...
              >
                <div
                  className="bg-light rounded-4 d-flex align-items-center justify-content-center text-indigo mb-3"
            ...
            <div className="col-lg-6">
              ...
              <div className="d-flex flex-column gap-5">
                <div className="d-flex gap-3">
                  <div
                    className="bg-light rounded-4 d-flex align-items-center justify-content-center text-indigo flex-shrink-0"
                    style={{ width: "48px", height: "48px" }}
                  >
                    <Target size={24} />
                  </div>
                ...
                <div className="d-flex gap-3">
                  <div
                    className="bg-light rounded-4 d-flex align-items-center justify-content-center text-purple flex-shrink-0"
                    style={{ width: "48px", height: "48px", color: "#7c3aed" }}
                  >
                    <Eye size={24} />
                  </div>
                  <div>
                    ...
                    <p className="text-secondary small mb-0">
                      A world where every healthcare facility is perfectly
                      staffed and every medical professional finds their ideal
                      role effortlessly.
                    </p>
                  </div>
                </div>
                  ...
                  {teamMembers.map((member, i) => (
                    <div key={i} className="d-flex align-items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-indigo fw-semibold small mb-1">
                          {member.role}
                        </p>
                        <p
                          className="text-secondary x-small mb-0"
      ...
      <section className="py-5 bg-light border-top">
        <div className="container py-5 text-center">
          ...
          <p
            className="text-secondary mb-5 mx-auto"
          ...
          <div className="row g-4 justify-content-center">
            <div className="col-md-5">
              <div className="card p-5 rounded-5 h-100 shadow-sm border-0">
                ...
                <Link to="/signup" className="btn btn-primary w-100 rounded-4">
                  Join as Seeker
                </Link>
              </div>
            </div>
            <div className="col-md-5">
              <div className="card p-5 rounded-5 h-100 shadow-sm border-0 bg-dark text-white">
                ...
                <p className="text-light opacity-75 small mb-4">
                  Post job listings and browse verified professionals to grow
                  your medical team.
                </p>
                <Link
                  to="/signup"
