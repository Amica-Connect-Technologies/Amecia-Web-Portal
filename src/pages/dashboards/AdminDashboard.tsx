...
const AdminDashboard: React.FC = () => {
  ...
  const [recentActivity, setRecentActivity] = useState<ActivityLog[]>([
    {
      id: "1",
      action: "New Provider Signup",
      user: "St. Jude Hospital",
      status: "Success",
      time: "2m ago",
    },
    {
  ...
  const stats = [
    ...
    { label: "Jobs", value: "450", bg: "bg-success", icon: Briefcase },
    {
      label: "Providers",
      value: (
        86 + recentActivity.filter((a) => a.action === "Provider Added").length
      ).toString(),
      bg: "bg-warning",
      icon: Stethoscope,
    },
  ...
  const addActivity = (
    action: string,
    user: string,
    status: "Success" | "Rejected" | "Pending" = "Success"
  ) => {
  ...
  return (
    <div className="bg-dark min-vh-100 py-5 animate-fade-in">
      <div className="container-fluid px-md-5">
        <header className="mb-5 text-white">
          ...
          <p className="opacity-50">
            System management and healthcare network oversight
          </p>
        </header>
        ...
        <div className="card rounded-5 shadow-lg border-0 overflow-hidden">
          <div className="card-header bg-dark p-4 d-flex justify-content-between align-items-center border-0">
            ...
            <button
              ...
              className="btn btn-outline-danger btn-sm rounded-pill px-3 d-flex align-items-center gap-2 border-secondary text-secondary hover-bg-danger hover-text-white transition-all shadow-none"
            >
            ...
            <div className="row g-3 mb-5">
              {stats.map((stat, i) => (
                <div key={i} className="col-6 col-md">
                  <div
                    className={`${
                      stat.bg || "bg-secondary"
                    } p-4 rounded-4 shadow-sm text-white h-100 transition-all hover-shadow`}
                  >
                    <p
                      className="x-small fw-bold opacity-75 mb-3 text-uppercase"
              ...
              <div className="col-lg-8">
                <div className="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
                  ...
                  <button
                    ...
                    className="btn btn-link text-secondary x-small fw-bold text-decoration-none p-0"
                  >
                    Clear Logs
                  </button>
                </div>
                  ...
                  <div className="table-responsive">
                    <table className="table table-hover align-middle mb-0">
                      <thead className="bg-white">
                        <tr
                          className="x-small fw-black text-uppercase text-secondary"
                          style={{
                            fontSize: "0.65rem",
                        ...
                        {recentActivity.length > 0 ? (
                          recentActivity.map((log) => (
                            <tr key={log.id} className="bg-white border-bottom">
                              <td className="px-4 py-3 fw-bold small text-dark">
                                {log.action}
                              </td>
                              ...
                              <td className="px-4 py-3 text-center">
                                <span
                                  className={`badge rounded-pill fw-black x-small text-uppercase px-2 py-1 ${
                                    log.status === "Success"
                              ...
                              <td className="px-4 py-3 x-small text-secondary text-end fw-medium">
                                {log.time}
                              </td>
                            </tr>
                          ))
                          ...
                          <tr>
                            <td
                              colSpan={4}
                              className="text-center py-5 text-secondary small italic"
                            >
              ...
              <aside className="col-lg-4">
                <div className="mb-5">
                  ...
                  <div className="d-grid gap-3">
                    <button
                      ...
                      className="btn btn-primary btn-lg rounded-4 fw-bold py-3 d-flex justify-content-between align-items-center shadow-sm"
                    >
                ...
                <div>
                  <h3 className="h5 fw-bold mb-4 text-dark border-bottom pb-2 d-flex align-items-center justify-content-between">
                    Pending Jobs
                    <span className="badge bg-indigo rounded-pill x-small">
                      {pendingJobs.length}
                    </span>
                  </h3>
                  <div className="d-flex flex-column gap-3">
                    {pendingJobs.length > 0 ? (
                      pendingJobs.map((job) => (
                        <div
                          key={job.id}
                          className="card rounded-4 p-3 border shadow-sm bg-white animate-fade-in"
                        >
                          <div className="d-flex justify-content-between align-items-start mb-2">
                            <div>
                              ...
                              <p className="x-small text-secondary mb-0 fw-medium">
                                at {job.company}
                              </p>
                            </div>
                            <button
                          ...
                          <div className="row g-2 mt-2">
                            <div className="col">
                              <button
                                ...
                                className="btn btn-indigo btn-sm w-100 rounded-3 fw-bold d-flex align-items-center justify-content-center gap-1 py-2 shadow-sm"
                              >
                            ...
                            <div className="col">
                              <button
                                onClick={() => handleReject(job.id)}
                                className="btn btn-outline-danger btn-sm w-100 rounded-3 fw-bold py-2 shadow-sm"
                              >
                                Reject
                              </button>
                            </div>
                      ...
                      <div className="text-center py-5 bg-light rounded-4 border border-dashed border-secondary-subtle">
                        <Briefcase
                          size={32}
                          className="text-secondary opacity-25 mb-2 mx-auto"
                        />
                        <p className="x-small text-secondary fw-bold mb-0">
      ...
      {isProviderModalOpen && (
        ...
        >
          <div
            className="card rounded-5 border-0 shadow-lg animate-fade-in"
          ...
          >
            <div className="card-header bg-white p-4 border-0 d-flex justify-content-between align-items-center rounded-top-5">
              ...
              <button
                ...
                className="btn btn-light rounded-circle p-2 text-secondary hover-text-dark border-0 shadow-none"
              >
                <X size={20} />
              </button>
            </div>
            <div className="card-body p-4 p-md-5">
              ...
              >
                <div>
                  <label
                    className="x-small fw-black text-secondary text-uppercase mb-2 d-flex align-items-center gap-2"
                    style={{ fontSize: "0.65rem", letterSpacing: "0.05rem" }}
                  >
                    <Stethoscope size={14} className="text-indigo" /> Facility /
                    Doctor Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="d-flex gap-2 mt-2">
                  <button
                    type="button"
                    onClick={() => setIsProviderModalOpen(false)}
                    className="btn btn-light btn-lg rounded-4 flex-grow-1 fw-bold text-secondary border"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="btn btn-primary btn-lg rounded-4 flex-grow-2 fw-bold d-flex align-items-center justify-content-center gap-2 px-5 shadow-sm"
                  >
