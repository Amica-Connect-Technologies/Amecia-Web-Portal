...
const ALL_PROS = [
  { id: '1', name: 'Dr. Emily Watson', title: 'Consultant Surgeon', specialty: 'General Surgery', loc: 'London, UK' },
  { id: '2', name: 'James Morrison', title: 'Nurse Practitioner', specialty: 'Critical Care', loc: 'Manchester, UK' },
  { id: '3', name: 'Dr. Sarah Chen', title: 'Pediatrician', specialty: 'Early Childhood', loc: 'Sydney, AU' },
  { id: '4', name: 'Michael Ross', title: 'Pharmacist', specialty: 'Retail Pharmacy', loc: 'New York, USA' },
  { id: '5', name: 'Anna Belova', title: 'Neurologist', specialty: 'Brain Studies', loc: 'Berlin, DE' },
  { id: '6', name: 'David Kim', title: 'Orthodontist', specialty: 'Dental Braces', loc: 'Seoul, KR' },
];
    ...
    <div className="bg-body-tertiary min-vh-100 py-5 animate-fade-in">
      <div className="container">
        <div className="text-center mb-5">
          ...
          <p className="text-secondary small">Browse healthcare professionals and their qualifications</p>
        </div>

        <div className="card p-3 rounded-4 shadow-sm border-0 mb-5 mx-auto" style={{maxWidth: '600px'}}>
            ...
            Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="col-md-6 col-lg-4">
                <div className="card h-100 rounded-5 border-0 shadow-sm p-5 bg-white animate-pulse">
                  <div className="bg-light rounded-circle mx-auto mb-4" style={{width: '96px', height: '96px'}}></div>
            ...
            filteredPros.map(pro => (
              <div key={pro.id} className="col-md-6 col-lg-4">
                <div className="card h-100 rounded-5 border-0 shadow-sm p-4 text-center transition-all hover-shadow">
                  <div className="mx-auto mb-4 position-relative" style={{width: '100px'}}>
                  ...
                  <Link to={`/provider/${pro.id}`} className="btn btn-primary w-100 rounded-3 py-3 fw-bold">
                    View Profile
                  </Link>
                </div>
              </div>
