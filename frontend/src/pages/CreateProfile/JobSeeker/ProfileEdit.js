...
const ProfileEdit = () => {
    ...
    if (type === 'file') {
      ...
      if (name === 'profile_picture') {
        ...
        if (file) {
          ...
          // If file is cleared, keep existing preview
  ...
  const handleRemoveProfilePic = () => {
    ...
    // Note: To actually remove from server, you might need a separate API call
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ['first_name', 'last_name', 'profession', 'experience_years'];
    ...
    try {
      ...
      const response = await profileAPI.saveProfile(formDataObj);
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">
            {formData.first_name ? 'Edit Your Profile' : 'Create Your Profile'}
          </h1>
          <p className="mt-2 text-gray-600">
            {formData.first_name ? 'Update your information' : 'Complete your profile to get started'}
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
            ...
            <div className="space-y-6">
                    ...
                    <div className="flex-shrink-0 relative">
                      ...
                      <div className="relative group">
                        ...
                        <button
                          ...
                          className="absolute -top-2 -right-2 bg-red-100 text-red-600 rounded-full p-1 opacity-0 group-hover:opacity-100 transition hover:bg-red-200"
                        >
              ...
              <div>
                ...
                {certificationsFile && (
                  <p className="mt-2 text-sm text-green-600">
                    ✓ New certification selected: {certificationsFile.name}
                  </p>
                )}
            ...
            >
              {loading ? (
                <>
                  ...
                  {formData.first_name ? 'Updating...' : 'Creating...'}
                </>
              ) : (
                formData.first_name ? 'Update Profile' : 'Create Profile'
              )}
            </button>
          </div>
        </form>
