...
export const profileAPI = {
  // Get profile - SIMPLIFIED: just fetch profile data
  getProfile: async () => {
    try {
  ...
  // Check if profile exists (alternative approach)
  ...
  // Dashboard specific profile APIs (keep as is)
  ...
  // User type specific profile checks
